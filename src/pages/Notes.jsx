        ...
        <div className="w-full md:w-1/3 bg-emerald-50 border border-emerald-100 p-4 rounded-xl shadow-sm">
          ...
          {notes.map((note) => {
            return (
              <div
                key={note.id}
                className={`p-4 rounded-lg mb-3 cursor-pointer border transition relative
                  ${
              ...
              >
                <h1 className="font-semibold text-gray-800">{note.title}</h1>
        ...
        <div className="w-full md:w-2/3 bg-emerald-50 border border-emerald-100 p-4 rounded-xl shadow-sm">
          <div className="flex gap-3 mb-3">
            <input
              ...
              className="flex-1 bg-white p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-emerald-400"
            />
            <button
              onClick={saveNote}
          ...
          <textarea
            ...
            className="bg-white p-3 rounded-lg w-full h-56 border border-gray-300 resize-none focus:outline-none focus:ring-2 focus:ring-emerald-400"
          ></textarea>
        </div>
      </div>
    </div>
