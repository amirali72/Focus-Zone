...
const Weather = () => {
  ...
  return (
    <div className="bg-linear-to-br from-green-100 to-teal-200 flex items-center justify-center p-3 sm:p-4 rounded-xl">

      <div className="w-full max-w-md bg-white/85 backdrop-blur-md shadow-lg rounded-xl p-3 sm:p-4 space-y-3 sm:space-y-4">
        ...
        <div className="flex items-center gap-2">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full pl-8 sm:pl-9 pr-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-teal-500 outline-none text-xs sm:text-sm"
            />
          </div>

          <button
            onClick={getWeather}
            className="px-3 sm:px-4 py-2 bg-teal-600 text-white text-xs sm:text-sm font-medium rounded-lg shadow hover:bg-teal-700 transition"
          >
            Search
          </button>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex flex-col items-center gap-1">
              <h1 className="text-3xl sm:text-4xl font-bold text-teal-600 flex items-center gap-1">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 text-gray-700 pt-2 sm:pt-3">
              ...
              <div className="flex flex-col items-center bg-white rounded-lg p-2 sm:p-3 shadow">
